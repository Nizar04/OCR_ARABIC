...
racine_gt = r"C:/Users/nizar/OCR2/enit_ifn database/data/set_a/tru"
...
class CRNN:
    ...
    def build_model(self):
        # Input layer
        input_data = Input(name='the_input', shape=(self.img_w, self.img_h, 1), dtype='float32')

        # Convolutional layers
        conv_1 = Conv2D(self.conv_filters, self.kernel_size, padding='same', activation='relu', name='conv1')(input_data)
